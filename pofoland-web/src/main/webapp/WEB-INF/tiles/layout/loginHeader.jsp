            ...
            <div class="navbar-collapse nav-main-collapse collapse">
                ...
                <div class="search" id="headerSearch">
                    ...
                    <div class="search-input" style="display: none;">
                        <form id="headerSearchForm" action="#" method="get" novalidate="novalidate">
                ...
                <nav class="nav-main mega-menu one-page-menu">
                    <ul class="nav nav-pills nav-main" id="mainMenu">
                        ...
                        <li>
                            <a href="/register"><i class="fa fa-mail-forward"></i>Register</a>
                        </li>
                        <li>
                                                ...
                                                <ul class="sub-menu">
                                                    <li>
                                                        ...
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li><a class="current" href="page-login.html">Login Page</a></li>
